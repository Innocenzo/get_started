...
router.get("/api/contacts/:id",ensureAuthenticated, function(req, res) {
  ...
  router.post("/api/contacts",ensureAuthenticated, function(req, res) {
    // console.log("routes");
  ...
  router.put("/api/contacts/:id",ensureAuthenticated, function(req, res) {
    console.log("put");
    console.log(req.params.id);
    if (req.params.id==req.user.uuid) {
  ...
  router.delete("/api/contacts/:id",ensureAuthenticated, function(req, res) {
    console.log("delete");
    console.log(req.params.id);
    if (req.params.id==req.user.uuid) {
      models.Contact.findById(req.params.id).then(function(contact) {
